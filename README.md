...
目前进行本地化工作的译者有：单凌锐、烬羽。参与本地化工作的有：朝歌。采用大语言模型翻译，人工校对的的方式进行，确保至少达成“信达雅”标准的前两者。（机器翻译只是用以提高翻译效率的附属手段，请勿**直接**搬用机翻结果。）

预期实现完全本地化的工作或将持续~~1年~~ 2年（也就是预计~~2026年~~ 2027年年初完成全部的汉化工作）
